...
//   Kleisli(doric.types.SparkType$$Lambda$2286/2017018978@5ce03a9d),
//   "str"
// )
val col2 = colString(c"int")
// col2: NamedDoricColumn[String] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2286/2017018978@772589ed),
//   "int"
// )
val col3 = colInt(c"unknown")
// col3: NamedDoricColumn[Int] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2286/2017018978@4619854a),
//   "unknown"
// )
```
```scala
...
//   Kleisli(doric.types.SparkType$$Lambda$2286/2017018978@655b9169),
//   "name_user"
// )
colInt(c"age_user")
// res3: NamedDoricColumn[Int] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2286/2017018978@4917992b),
//   "age_user"
// )
colString(c"city_user")
// res4: NamedDoricColumn[String] = NamedDoricColumn(
//   Kleisli(doric.types.SparkType$$Lambda$2286/2017018978@62536882),
//   "city_user"
// )
```
