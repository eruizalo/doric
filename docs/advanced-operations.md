...
//   Kleisli(cats.data.Kleisli$$Lambda$1493/1541831888@da4c5cb)
// ) // 
...
//   Kleisli(cats.data.Kleisli$$Lambda$1493/1541831888@1fa24e7)
...
//   Kleisli(doric.syntax.NonEmptyTypeMatcher$$Lambda$2976/548782193@5192b301)
// )
```
...
//   Kleisli(doric.syntax.NonEmptyTypeMatcher$$Lambda$3011/25336008@7b9d602c)
// )
```
```scala
